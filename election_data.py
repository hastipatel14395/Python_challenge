...
csv_file_path = Path("/Users","hasti","Desktop","Python-challenge", "election_data.csv")
...
# Output files
# Assign output file
output_file = Path("Desktop","Python-challenge","Election_Results_Summary.txt")
